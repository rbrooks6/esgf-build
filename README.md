...
2. Execute updateall.sh passing the branch to be updated as a command line argument (i.e. updateall.sh devel), to sequentially checkout the latest commit from the active branch. It also creates the taglist file, which you should check, to see if there are any commits after the last annotated tags.
